...
<body>
<div style="color: white; text-align: center; font-size: 30px;">Orders Received</div>
<%
                 ...
                 <td><%=rs.getString(11)%></td>
                  <td><%=rs.getString(12)%></td>
                   ...
                   <td><%=rs.getString(15)%></td>
                    <td><a  href="cancleOrdersAction.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1) %>">Cancel <i class='fas fa-close'></i></a></td>
